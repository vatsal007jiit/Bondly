  ...
  const Header: React.FC<HeaderProps> = ({ toggleDark }) => {
    ...
    return (
      ...
      <div className="flex items-center gap-5 text-xl text-gray-600 dark:text-gray-300">
        ...
        <FiBell className="hover:text-indigo-600 dark:hover:text-indigo-400 cursor-pointer" title="Notifications" />
        <FiUser className="hover:text-indigo-600 dark:hover:text-indigo-400 cursor-pointer" title="Profile" />
      ...
      //   {/* Right: Icons */}
      //   <div className="flex items-center gap-5 text-xl text-gray-600 dark:text-gray-300">
      //     <FiHome className="hover:text-indigo-600 dark:hover:text-indigo-400 cursor-pointer" title="Home" />
      //     <FiMessageSquare className="hover:text-indigo-600 dark:hover:text-indigo-400 cursor-pointer" title="Messages" />
      //     <FiBell className="hover:text-indigo-600 dark:hover:text-indigo-400 cursor-pointer" title="Notifications" />
      //     <FiUser className="hover:text-indigo-600 dark:hover:text-indigo-400 cursor-pointer" title="Profile" />
      //     <button onClick={toggleDark} title="Toggle Theme">
